...
public interface IClasspathDescriptor {
   ...
   */
  IClasspathEntryDescriptor addLibraryEntry(Artifact artifact, IPath srcPath, IPath srcRoot, String javaDocUrl);
   ...
   * @deprecated this method exposes Maven core classes, which are not part of m2eclipse-jdt API
   */
  IClasspathEntryDescriptor addProjectEntry(Artifact artifact, IMavenProjectFacade projectFacade);
}
