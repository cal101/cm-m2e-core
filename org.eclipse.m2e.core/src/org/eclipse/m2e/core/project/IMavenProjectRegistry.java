...
public interface IMavenProjectRegistry {
   ...
   */
  void refresh(MavenUpdateRequest request, IProgressMonitor monitor) throws CoreException;
   ...
   */
  MavenExecutionRequest createExecutionRequest(IFile pom, ResolverConfiguration resolverConfiguration,
      IProgressMonitor monitor) throws CoreException;

  /**
   * @deprecated This method does not properly join {@link IMavenExecutionContext}
   */
  MavenExecutionRequest createExecutionRequest(IMavenProjectFacade project, IProgressMonitor monitor)
