...
public interface MavenLaunchConstants {
   ...
   */
  String BUILDER_CONFIGURATION_TYPE_ID = "org.eclipse.m2e.Maven2BuilderConfigurationType"; //$NON-NLS-1$
   ...
   * @deprecated this constant is not used by m2e
   */
  String ATTR_GOALS_AUTO_BUILD = "M2_GOALS_AUTO_BUILD"; //$NON-NLS-1$

  /**
   * @deprecated this constant is not used by m2e
   */
  String ATTR_GOALS_MANUAL_BUILD = "M2_GOALS_MANUAL_BUILD"; //$NON-NLS-1$

  /**
   * @deprecated this constant is not used by m2e
   */
  String ATTR_GOALS_CLEAN = "M2_GOALS_CLEAN"; //$NON-NLS-1$

  /**
   * @deprecated this constant is not used by m2e
   */
  String ATTR_GOALS_AFTER_CLEAN = "M2_GOALS_AFTER_CLEAN"; //$NON-NLS-1$
